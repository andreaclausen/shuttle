...
Shuttle.prototype.updatePosition = function(dt) 
{
    ...
    if (this.states.movingForward || this.states.movingBackward)
    {
        ...
        // autopilot break
        /*if (shuttle.position.longitude !== closest.placemark.getGeometry().getLongitude() && shuttle.position.latitude !== closest.placemark.getGeometry().getLatitude())
        {
            this.states.movingFoward == false;
        }*/
    }  
